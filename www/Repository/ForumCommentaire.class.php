...
class ForumCommentaire {
    ...
    public static function getInformationsForumCommentaire()
    {
        ...
        $forumCommentaireModel->select(["mnga_forumcommentaire.id", "mnga_forumcommentaire.commentaire",  "mnga_forumcommentaire.date_creation", "mnga_forum.title as forum_title", "mnga_user.firstname as user_firstname", "mnga_user.lastname as user_lastname"]);
