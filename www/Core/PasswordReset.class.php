...
class PasswordReset extends Sql
{
    public static function checkFormPasswordReset($config, $data):array
    {
        ...
        if ($results == false) {
            ...
            $body ="Bonjour,<br>Cliquer sur le lien pour modifier votre mot de passe : <a href=".$_SERVER['HTTP_HOST']."/initialiser_mdp/".$data["email"]."/".$results[1]."'>Initialiser mot de passe</a>";
